<template>
    ...
    <div class=" container-fluid   card shadow-lg   blur ">
        <Swiper class="w-100 p-2 rounded bg-light"
        ...
        <div class="row rounded m-2 justify-content-center  text-primary   bg-light px-1   "
        >
            <div :class="admin?'col-md-6  ':'col-ms-6 col-sm-4'">
            ...
            <div :class="admin && users.length==0?'col-sm-6':'col-ms-6 col-sm-5'" v-show="filter">
            ...
            <div class="  align-self-center" :class="admin?'col-md-6  ':'col-sm-6 col-md-4'" v-show="filter">
                <div class="btn-group shadow-0 w-100  ">
                    <input
                            type="radio"
                            class="btn-check"
                            name="gender"
                    ...
                    <input @change="getData(1)" v-model="params.gender" value="m" type="radio" class="btn-check"
                           ...
                           id="gender-man"
                           autocomplete="off"/>
                    <label class="btn btn-outline-primary" for="gender-man">مرد</label>

                    <input @change="getData(1)" v-model="params.gender" value="w" type="radio" class="btn-check"
                           name="gender"
                           id="gender-woman"
                           autocomplete="off"/>
                    <label class="btn btn-outline-primary" for="gender-woman">زن</label>
                </div>
            </div>
            <div v-if="admin && filter" class="col-sm-6  ">
            ...
            <div v-if="admin && filter&& users.length>0" class="col-ms-6 col-md-4">
            ...
            <slider v-show="filter" class="col-sm-6 col-md-4 align-self-center   " id="ageSlider" ref="ageSlider"
                    :min="0"
                    :max="100"
                    label="محدوده سن">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div class="numbers ms-1">
                                                ...
                                                <div class="small text-secondary text-opacity-100 font-weight-bold   ">
                                                    {{ getSport(d.sport_id)}}

                                                </div>
                                                <div class="small  text-opacity-100 font-weight-bolder   ">
                                                    {{getProvinceCounty(d.province_id, d.county_id)}}

                                                </div>
                                                <div class="small text-indigo  text-opacity-100 font-weight-bold   ">
                                                    <span class="mx-1"> سن: {{getAge(d.born_at)}}</span>

                                                </div>
                                                <div class="small text-success text-opacity-100 font-weight-bold   ">
                                                    همراه: {{ d.phone }}
