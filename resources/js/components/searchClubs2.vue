<template>
    ...
    <div class=" container-fluid    card shadow-lg   blur ">
        ...
        >
            <div :class="admin?'col-md-6  ':'col-ms-6'">
            ...
            <div :class="admin? 'col-md-6' :'col-ms-6 '" v-show="filter">
                <div class=" my-2   input-group  ">

                    <input id="name" type="text"
                           class="  px-4 form-control   "
                           v-model="params.name"
                           @keyup.enter="getData(1)" placeholder="نام باشگاه"
                           autofocus>
                    <!--<label for="search"-->
            ...
            <div :class="!admin  || users.length==0?'col-ms-6':'col-ms-6'" v-show="filter">
            ...
            <div :class="admin?'col-md-6  ':'col-sm-6'" v-show="filter">
                <div class="btn-group w-100 my-2">
                    <input
                            ...
                            checked
                    />
                    <label class="btn btn-outline-primary" for="gender-all">جنسیت</label>

                    <input @change="getData(1)" v-model="params.gender" value="m" type="radio" class="btn-check"
                           name="gender"
                           id="gender-man"
                           autocomplete="off"/>
                    <label class="btn btn-outline-primary" for="gender-man">آقایان</label>

                    <input @change="getData(1)" v-model="params.gender" value="w" type="radio" class="btn-check"
                           name="gender"
                           id="gender-woman"
                           autocomplete="off"/>
                    <label class="btn btn-outline-primary" for="gender-woman">بانوان</label>
                </div>
            </div>

            <div v-if="admin" class="col-md-6  " v-show="filter">
                <div class="btn-group w-100 my-2">
                    <input
                            type="radio"
                            class="btn-check"
        ...
        <div class="  container-fluid       shadow-card ">
            ...
            <div class=" col-12 mx-auto  mb-3 row     font-weight-bold text-primary border border-2 border-primary rounded bg-light p-2 mb-2 z-index-0 text-center ">
                ...
                <div class="col-6 hover-underline "
                     :class="params.order_by=='created_at' &&  params.dir =='ASC' ?'active':''"
                     @click="params.order_by='created_at';   params.dir ='ASC';   getData(1);">
                    قدیمی ترین
                </div>
            </div>
            ...
            <div :class=" admin || view=='horizontal'? '': 'card-container'" class="my-4">
                ...
                <div v-if=" admin" class="row mx-1 ">
                    <div v-for="d,idx in data" class="col-md-6   position-relative ">
                        ...
                        <a :href="'/panel/club/edit/'+d.id" class="m-1 d-block  ">
                ...
                <div v-if=" !admin && view=='horizontal'" class="row mx-1 ">
                    <div v-for="d,idx in data" class="col-md-6   position-relative ">
                        ...
                        <a :href="'/club/'+d.id" class="m-1 d-block  ">
                            <div class="card move-on-hover">
                        ...
                        <a :href="getLink(d.id, type)"
                           ...
                           :key="d.id">
                            ...
                            <div class="m-card-body  px-2 d-flex  flex-column  align-self-stretch  justify-content-between  text-end z-index-1">
                                ...
                                <div class="text-primary  my-2 text-center max-2-line "> {{d.name }}
                                </div>

                                <div class=" text-center    pt-1 ">
                                    <div class="row">
                                        <div class="col">
                                            <span class="  rounded-start   bg-primary text-white small   px-2 ">شناسه</span>
                                            <span class="   rounded-end  bg-secondary text-white small   px-2 ">  {{d.id}} </span>
                                        </div>
                                        <Swiper class="w-100 my-1"
                                                :slides-per-view="d.sports.length>1?2:'auto'"
                                                :centeredSlides="false"
                                                :grabCursor="false"
                                                :space-between="30"
                                                :freeMode="true"
                                        >
                                            <swiper-slide v-for="s in d.sports"
...
<script>
    ...
    export default {
        props: ['admin', 'dataLink', 'editLink', 'removeLink', 'province-data', 'county-data', 'sport-data', 'imgLink', 'assetLink', 'urlParams', 'type',],
        ...
        mounted() {
            ...
            getSport(times) {
                ...
                for (let idx in times) {
                    ...
                    t = this.sports.find(function (el) {

                        return times[idx].id == el.id;
                    });
...
//                                console.log(response.data.data);
                                ...
                                for (let i in this.data)
                                    this.data[i].sports = this.getSport(this.data[i].times);
