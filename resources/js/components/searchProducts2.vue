<template>
    ...
    <div class=" container-fluid    card shadow-lg   blur ">
        ...
        >
            ...
            <div class=" col-md-4 my-1" v-show="filter">
            ...
            <div class="col-md-6   my-1    " v-show="filter">
...
<script>
    ...
    export default {
        props: ['admin', 'dataLink', 'editLink', 'removeLink', 'shop-data', 'user-data', 'imgLink', 'assetLink', 'urlParams', 'type',],
