<template>
    ...
    >
        ...
        <swiper-slide v-for="d,idx in data" :style="'width:'+width">
               ...
               :key="d.id">
                ...
                <div class="m-card-body  px-2 d-flex  flex-column  align-self-stretch  justify-content-between  text-end z-index-1">
                    ...
                    <div class=" text-center     pt-1 ">
                        <span class="  rounded-start   bg-primary text-white small   px-2 ">{{getTypeName(d.type)}} </span>
                        ...
                        <p v-if="d.type!='pr'" class=" small text-primary text-center text-lg">
                            ...
                            <span class="mx-1 text-secondary">  {{getProvinceCounty(d.province_id, d.county_id)}}  </span>
...
<script>
    ...
    export default {
        ...
        props: ['dataLink', 'rootLink', 'imgLink', 'assetLink', 'width', 'provinceData'],
        data() {
            return {
