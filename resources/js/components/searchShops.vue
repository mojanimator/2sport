            ...
            <div :class=" panel || view=='horizontal'? '': 'card-container'" class="my-4">
                ...
                <div v-if=" !panel && view=='horizontal'" class="row mx-1 ">
                    <div v-for="d,idx in data" class="col-md-6 col-xl-4 px-0 px-sm-1  position-relative ">
                        ...
                        <a :href="'/shop/'+d.id" class="m-1 d-block  ">
                            <div class="card move-on-hover">
...
//                        console.log('invisible')
            ...
            getSport(sports) {
                ...
                for (let idx in sports) {

                    t = this.sports.find(function (el) {

                        return sports[idx] == el.id;
                    });
...
//                this.loading.removeClass('hide');
                ...
                this.params = {
                    ...
                    pname: this.params.pname ? this.params.pname : this.pname,
