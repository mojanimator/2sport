<template>
    ...
    <div class=" container-fluid    card shadow-lg   blur ">
        ...
        >
            <div :class="admin?'col-md-6':'col-ms-6 col-md-4'">
            ...
            <div :class="admin? 'col-md-6' :'col-ms-6  col-md-4 '" v-show="filter">
            ...
            <div :class="admin  ?'col-sm-6':'col-ms-6 col-md-4'" v-show="filter">
            ...
            <div v-if="admin" class="col-md-6  ">
                <div class="btn-group w-100 my-2">
                    <input
                            ...
                            checked
                    />
                    <label class="btn btn-outline-primary" for="active-all">وضعیت</label>
            ...
            <div v-if="filter" class=" " :class="admin?'col-md-6  ':'col-ms-12 col-md-4'">
                <div class="btn-group w-100 my-2 ">
                    <input
                            type="radio"
                            class="btn-check"
            ...
            <div v-if="admin && users.length>0" class="col-ms-6" v-show="filter">
            ...
            <div class="row mx-auto   py-1    " v-show="filter">
                <slider class="  col-sm-4  " id="ageSlider" ref="ageSlider" :min="0"
                        :max="100"
                        label="محدوده سن">

                </slider>
                <slider class="  col-sm-4  " id="weightSlider" ref="weightSlider"
                        :min="0" :max="500"
                        label="محدوده وزن">

                </slider>
                <slider class="  col-sm-4 mx-sm-auto " id="heightSlider" ref="heightSlider"
                        :min="0" :max="300"
                        label="محدوده قد">
        ...
        <div class="  container-fluid       shadow-card ">
            ...
            <div class=" col-12 mx-auto  mb-3 row     font-weight-bold text-primary border border-2 border-primary rounded bg-light p-2 mb-2 z-index-0 text-center ">
                ...
                <div class="col-3 hover-underline" :class="params.order_by=='weight'?'active':''"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div class="numbers">
                                                ...
                                                <div class="small text-secondary text-opacity-100 font-weight-bolder  my-1">
                                                    رشته: {{ getSport(d.sport_id)}}

                                                </div>
                                                <div class="small text-blue  text-opacity-100 font-weight-bolder  my-1">
                                                    شهر:  {{getProvinceCounty(d.province_id, d.county_id)}}

                                                </div>
                                                <div class="small text-indigo  text-opacity-100 font-weight-bolder  my-1">
                                                    <span class="mx-1"> سن: {{getAge(d.born_at)}}</span>
                                                    <span class="mx-1"> قد: {{ d.height}}</span>
                                                    <span class="mx-1"> وزن: {{ d.weight}}</span>

                                                </div>
                                                <div class="small text-success text-opacity-100 font-weight-bolder  my-1">
                                                    همراه: {{ d.phone }}
                           ...
                           :key="d.id">
                            ...
                            <div class="m-card-body  px-2 d-flex  flex-column  align-self-stretch  justify-content-between  text-end z-index-1">
                                ...
                                <div class=" text-center     pt-1 ">
                                    <div class="row">
                                        <div class="col">
                                            <span class="  rounded-start   bg-primary text-white small   px-2 ">{{ getSport(d.sport_id)}}</span>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <span class="  rounded-start   bg-primary text-white small   px-2 ">قد</span>
                                            <span class="   rounded-end  bg-secondary text-white small   px-2 ">  {{d.height}} </span>
                                        </div>
                                        <div class="col">
                                            <span class="  rounded-start   bg-primary text-white small   px-2 ">وزن</span>
                                            <span class="   rounded-end  bg-secondary text-white small   px-2 ">  {{d.weight}} </span>
                                        </div>
                                    </div>
