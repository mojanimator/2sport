...
@section('content')
    ...
    <section class="  row mx-auto   justify-content-center " style="margin-top: -7rem;">
        <div class="col-10  ">
            <div class="card shadow-3 opacity-75 blur">
 ...
 $days= get_object_vars($days );
        ...
        <section class="row px-5     mt-1 mt-md-3 ">
            ...
            <div class="col-md-6 bg-gradient-dark-transparent rounded-3  p-0  overflow-hidden" style="height: 18rem;">
                <div class=" bg-gradient-primary  p-2 overflow-hidden position-absolute rounded-bottom rounded-start   text-white"
                     style="z-index: 2"
                >
                    مراکز ورزشی
                </div>
        ...
        <section class=" mx-4 my-3 py-4 pe-4 ps-5  row bg-primary   rounded-3 position-relative  ">
