@php
    $user=auth()->user();
        ...
        $club=\App\Models\Club::where('user_id',$user->id)->where('id',$param)->with('docs:id,type_id,docable_id')->first();
    if ($club){
...
{{--{{json_encode( $images)}}--}}
@if(!$club)
    <div class="text-center font-weight-bold text-danger mt-5">باشگاه یافت نشد</div>
@else
                            ...
                            <div class="modal  fade  " id="renewModal" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        @foreach(\App\Models\Setting::where('key','like','club%')->where('key','like','%_price')->get() as $idx=> $sub)
                                            <!-- Default radio -->
