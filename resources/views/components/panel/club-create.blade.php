@cannot('createItem',[\App\Models\User::class,\App\Models\Club::class,false ])
    @php
                ...
                <div class="card-body  ">
                    ...
                    <form id="form-create" method="POST" action="{{ route('club.create') }}" class="text-right  row">
                        ...
                        <div class="  my-2 ">
                            ...
                            <club-times ref="clubTimes" class="row border border-2 border-primary rounded-2 py-4  px-1"
...
@push('scripts')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function (event) {
            ...
            let map = leaflet('{{null}}', '{{'مکان مرکز ورزشی'}}', 'edit');
