<div class="row mt-3  mx-auto  ">
    <div class="col-md-6   ">
        <a href="{{url('panel/shop/create')}}" class="my-1  d-block ">
    ...
    <search-shops
            price="{{\App\Models\Setting::firstOrNew(['key'=>'shop_price'])->value?:0}}"
            admin="{{$admin}}"
            panel="{{true}}"
            type="{{Helper::$typesMap['shops']}}"
            img-link="{{asset("storage/")}}"
            asset-link="{{asset("img/")}}"
            edit-link="{{route('shop.edit')}}"
            remove-link="{{route('shop.remove')}}"
