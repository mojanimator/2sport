@cannot('createItem',[\App\Models\User::class,\App\Models\Coach::class,false ])
    @php
    ...
    <div class="row mx-auto justify-content-center">
        <div class="col-md-10 mx-auto  ">
            <div class="card bg-light">
                <h5 class="card-header text-center text-white bg-primary">ثبت مربی</h5>
    ...
    <script>
        ...
        function submitWithFiles(event) {
            ...
            for (let i in data) {
                ...
                } else if (['phone', 'phone_verify', 'd', 'm', 'y'].includes(data[i].name)) {
